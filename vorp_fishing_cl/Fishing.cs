...
namespace vorp_fishing
{
	public class Fishing : BaseScript
	{
		...
		private static float actualReelSpeed = 0.0825f;
		private static int prompt_group;
		...
		public string ReelInText { get; set; }
		...
		public Fishing()
		{
			...
			EventHandlers["vorp_fishing:UseBait"] += new Action<string>(UseBait);
			Tick += FishingCore;
		...
		private static readonly List<FishData> FishDatas = new List<FishData> {
			new FishData(API.GetHashKey("A_C_FishBluegil_01_ms"), FishLocation.River, FishBait.p_finishedragonfly01x, 0.2f, 0.9f, "a_c_fishbluegil_01_ms", "PROVISION_FISH_BLUEGILL", "PROVISION_BLUEGILL_DESC"),
			new FishData(API.GetHashKey("A_C_FishBluegil_01_sm"), FishLocation.Lake, FishBait.p_baitCheese01x | FishBait.p_baitBread01x, 0.2f, 0.5f, "a_c_fishbluegil_01_sm", "PROVISION_FISH_BLUEGILL", "PROVISION_BLUEGILL_DESC"),
			new FishData(API.GetHashKey("A_C_FishBullHeadCat_01_ms"), FishLocation.Swamp, FishBait.p_finishedragonfly01x, 0.25f, 0.9f, "a_c_fishbullheadcat_01_ms", "PROVISION_FISH_BULLHEAD_CATFISH", "PROVISION_BULHDCATFSH_DESC"),
			new FishData(API.GetHashKey("A_C_FishBullHeadCat_01_sm"), FishLocation.Swamp, FishBait.p_baitCorn01x | FishBait.p_baitCheese01x, 0.1f, 0.5f, "a_c_fishbullheadcat_01_sm", "PROVISION_FISH_BULLHEAD_CATFISH", "PROVISION_BULHDCATFSH_DESC"),
			new FishData(API.GetHashKey("A_C_FishChainPickerel_01_ms"), FishLocation.River, FishBait.p_baitCricket01x | FishBait.p_finishedragonfly01x, 0.25f, 0.9f, "a_c_fishchainpickerel_01_ms", "PROVISION_FISH_CHAIN_PICKEREL", "PROVISION_CHNPKRL_DESC"),
			new FishData(API.GetHashKey("A_C_FishChainPickerel_01_sm"), FishLocation.River, FishBait.p_baitCorn01x | FishBait.p_baitCheese01x, 0.1f, 0.5f, "a_c_fishchainpickerel_01_sm", "PROVISION_FISH_CHAIN_PICKEREL", "PROVISION_CHNPKRL_DESC"),
			new FishData(API.GetHashKey("A_C_FishChannelCatfish_01_lg"), FishLocation.Swamp, FishBait.p_finishedragonfly01x, 6.3f, 9.2f, "a_c_fishchannelcatfish_01_lg", "PROVISION_FISH_CHANNEL_CATFISH", "PROVISION_CHNCATFSH_DESC"),
			new FishData(API.GetHashKey("A_C_FishChannelCatfish_01_XL"), FishLocation.Swamp, FishBait.p_finishedragonfly01x, 7.5f, 10.2f, "a_c_fishchannelcatfish_01_xl", "PROVISION_FISH_CHANNEL_CATFISH", "PROVISION_CHNCATFSH_DESC"),
			new FishData(API.GetHashKey("A_C_FishLakeSturgeon_01_lg"), FishLocation.Lake, FishBait.p_baitCricket01x | FishBait.p_FinisdFishlure01x, 6.3f, 9.2f, "a_c_fishlakesturgeon_01_lg", "PROVISION_FISH_LAKE_STURGEON", "PROVISION_LKSTURG_DESC"),
			new FishData(API.GetHashKey("A_C_FishLargeMouthBass_01_lg"), FishLocation.Swamp, FishBait.p_finishdcrawd01x | FishBait.p_finishedragonfly01x, 4.3f, 6.2f, "a_c_fishlargemouthbass_01_lg", "PROVISION_FISH_LARGEMOUTH_BASS", "PROVISION_LRGMTHBASS_DESC"),
			new FishData(API.GetHashKey("A_C_FishLargeMouthBass_01_ms"), FishLocation.Swamp, FishBait.p_finishdcrawd01x, 1.8f, 2.7f, "a_c_fishlargemouthbass_01_ms", "PROVISION_FISH_LARGEMOUTH_BASS", "PROVISION_LRGMTHBASS_DESC"),
			new FishData(API.GetHashKey("A_C_FishLongNoseGar_01_lg"), FishLocation.Swamp, FishBait.p_FinisdFishlure01x, 6.3f, 9.2f, "a_c_fishlongnosegar_01_lg", "PROVISION_FISH_LONGNOSE_GAR", "PROVISION_LNGNOSEGAR_DESC"),
			new FishData(API.GetHashKey("A_C_FishMuskie_01_lg"), FishLocation.Lake, FishBait.p_FinisdFishlure01x, 6.3f, 9.5f, "a_c_fishmuskie_01_lg", "PROVISION_FISH_MUSKIE", "PROVISION_MUSKIE_DESC"),
			new FishData(API.GetHashKey("A_C_FishNorthernPike_01_lg"), FishLocation.River, FishBait.p_baitCricket01x | FishBait.p_finishedragonfly01x, 6.3f, 9.2f, "a_c_fishnorthernpike_01_lg", "PROVISION_FISH_NORTHERN_PIKE", "PROVISION_NPIKE_DESC"),
			new FishData(API.GetHashKey("A_C_FishPerch_01_ms"), FishLocation.River, FishBait.p_baitBread01x | FishBait.p_baitCorn01x, 0.26f, 0.9f, "a_c_fishperch_01_ms", "PROVISION_FISH_PERCH", "PROVISION_PERCH_DESC"),
			new FishData(API.GetHashKey("A_C_FishPerch_01_sm"), FishLocation.Lake, FishBait.p_baitBread01x | FishBait.p_baitCorn01x, 0.15f, 0.5f, "a_c_fishperch_01_sm", "PROVISION_FISH_PERCH", "PROVISION_PERCH_DESC"),
			new FishData(API.GetHashKey("A_C_FishRainbowTrout_01_lg"), FishLocation.Lake, FishBait.p_baitCricket01x | FishBait.p_FinisdFishlure01x, 1.5f, 2.7f, "a_c_fishrainbowtrout_01_lg", "PROVISION_FISH_STEELHEAD_TROUT", "PROVISION_FISH_STHDTROUT_DESC"),
			new FishData(API.GetHashKey("A_C_FishRainbowTrout_01_ms"), FishLocation.Lake, FishBait.p_baitCricket01x | FishBait.p_FinisdFishlure01x, 0.5f, 1.5f, "a_c_fishrainbowtrout_01_ms", "PROVISION_FISH_STEELHEAD_TROUT", "PROVISION_FISH_STHDTROUT_DESC"),
			new FishData(API.GetHashKey("A_C_FishRedfinPickerel_01_ms"), FishLocation.River, FishBait.p_FinisdFishlure01x, 0.26f, 0.9f, "a_c_fishredfinpickerel_01_ms", "PROVISION_FISH_REDFIN_PICKEREL", "PROVISION_RDFNPCKREL_DESC"),
			new FishData(API.GetHashKey("A_C_FishRedfinPickerel_01_sm"), FishLocation.River, FishBait.p_baitCheese01x, 0.17f, 0.5f, "a_c_fishredfinpickerel_01_sm", "PROVISION_FISH_REDFIN_PICKEREL", "PROVISION_RDFNPCKREL_DESC"),
			new FishData(API.GetHashKey("A_C_FishRockBass_01_ms"), FishLocation.Lake, FishBait.p_baitCorn01x | FishBait.p_baitCheese01x, 0.26f, 0.9f, "a_c_fishrockbass_01_ms", "PROVISION_FISH_ROCK_BASS", "PROVISION_ROCKBASS_DESC"),
			new FishData(API.GetHashKey("A_C_FishRockBass_01_sm"), FishLocation.Lake, FishBait.p_FinisdFishlure01x, 0.1f, 0.4f, "a_c_fishrockbass_01_sm", "PROVISION_FISH_ROCK_BASS", "PROVISION_ROCKBASS_DESC"),
			new FishData(API.GetHashKey("A_C_FishSalmonSockeye_01_lg"), FishLocation.River, FishBait.p_baitCricket01x | FishBait.p_finishedragonfly01x, 3.5f, 6.2f, "a_c_fishsalmonsockeye_01_lg", "PROVISION_FISH_SOCKEYE_SALMON", "PROVISION_SCKEYESAL_DESC"),
			new FishData(API.GetHashKey("A_C_FishSalmonSockeye_01_ml"), FishLocation.River, FishBait.p_FinisdFishlure01x, 7.2f, 9.2f, "a_c_fishsalmonsockeye_01_ml", "PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY", "PROVISION_SCKEYESAL_DESC"),
			new FishData(API.GetHashKey("A_C_FishSalmonSockeye_01_ms"), FishLocation.River, FishBait.p_baitCricket01x | FishBait.p_finishedragonfly01x, 1.2f, 2.7f, "a_c_fishsalmonsockeye_01_ms", "PROVISION_FISH_SOCKEYE_SALMON", "PROVISION_SCKEYESAL_DESC"),
			new FishData(API.GetHashKey("A_C_FishSmallMouthBass_01_lg"), FishLocation.River, FishBait.p_baitCricket01x, 2.2f, 3.5f, "a_c_fishsmallmouthbass_01_lg", "PROVISION_FISH_SMALLMOUTH_BASS", "PROVISION_SMLMTHBASS_DESC"),
			new FishData(API.GetHashKey("A_C_FishSmallMouthBass_01_ms"), FishLocation.River, FishBait.p_baitCheese01x, 1.8f, 2.7f, "a_c_fishsmallmouthbass_01_ms", "PROVISION_FISH_SMALLMOUTH_BASS", "PROVISION_SMLMTHBASS_DESC"),
		...
		private async Task FishingMinigame()
		{
			...
			{
				Function.Call((Hash)0x8A0FB4D03A630D21, ResetCastPrompt, 1);
				Function.Call((Hash)0x71215ACCFDE075EE, ResetCastPrompt, 1);
			}
			else
			{
				Function.Call((Hash)0x8A0FB4D03A630D21, ResetCastPrompt, 0);
			...
			if (this.FishingState_ == 12)
			{
				...
				if (this.CatchTimer < API.GetGameTimer())
				{
					...
					if (!this.ShowInfo)
					{
						...
						Function.Call((Hash)0x8A0FB4D03A630D21, KeepPrompt, 1);
						Function.Call((Hash)0x71215ACCFDE075EE, KeepPrompt, 1);
						Function.Call((Hash)0x8A0FB4D03A630D21, ThrowFishBackPrompt, 1);
						Function.Call((Hash)0x71215ACCFDE075EE, ThrowFishBackPrompt, 1);
					}

					bool isKeep = Function.Call<bool>((Hash)0x21E60E230086697F, KeepPrompt);
					bool isThrow = Function.Call<bool>((Hash)0x21E60E230086697F, ThrowFishBackPrompt);
					this.Hooked = false;
					if (isKeep && !this.AddItem)
					{
						...
						this.AddItem = true;
						TriggerServerEvent("vorp_fishing:FishToInventory", this.CurrentFishData.Type);
						//TriggerServerEvent("vorp_fishing:FishKept", this.CurrentFishData.Name, weight * 2.2, "Description of the fish");
						SetFishTaskState(data);
						data.FishHandle = 0;
						this.Hooked = false;
						RemoveBait();
					...
					if (isThrow)
					{
						//TriggerServerEvent("vorp_fishing:FishThrown", this.CurrentFishData.Name, weight * 2.2, "Description of the fish");
			...
			else
			{
				...
				Function.Call((Hash)0x8A0FB4D03A630D21, KeepPrompt, 0);
				Function.Call((Hash)0x71215ACCFDE075EE, KeepPrompt, 0);
				Function.Call((Hash)0x8A0FB4D03A630D21, ThrowFishBackPrompt, 0);
				Function.Call((Hash)0x71215ACCFDE075EE, ThrowFishBackPrompt, 0);
			}
			...
			if (this.FishingState_ == 6)
			{
				...
				if (API.IsControlPressed(0, 0xD9D0E1C0)) // G
				{
					...
					//+ Speed
					if (API.IsControlPressed(0, 0x6319DB71)) // Arrow UP
					{
						if (actualReelSpeed < reelSpeeds[1])
						{
							actualReelSpeed = Math.Min(reelSpeeds[1], actualReelSpeed + 0.0125f);
						}
					}
					//- Speed
					if (API.IsControlPressed(0, 0x05CA7C52)) //Arrow Down
					{
						if (actualReelSpeed > reelSpeeds[0])
						{
							actualReelSpeed = Math.Max(reelSpeeds[1], actualReelSpeed - 0.0125f);
						}
					}

					Vector3.Normalize(ref dest, out dest);
					dest = hookCoords + dest * actualReelSpeed;
					Debug.WriteLine(actualReelSpeed.ToString());
				...
				if (distance_van > 750.0f)
				{
					...
					if (this.FindFishTimer < gametimer && this.TargetFish == 0)
					{
						...
						Debug.WriteLine($"Interested Fish Entity: {this.TargetFish}");
		...
		private async Task RequestPtfx()
		{
			...
			Debug.WriteLine($"REQUEST EFFECTS");
		...
		//
		//
		//   AS THE TITLE SAYS USES THE BAITS :D
		//
		//
		private void UseBait(string bait)
		{
			...
			if (data.FishingState == 1)
			{
				...
				TriggerServerEvent("vorp_fishing:baitUsed", baitName);
			}
		...
		public static void SetupPrompts()
		{
			...
			ResetCastPrompt = Function.Call<int>((Hash)0x04F97DE45A519419);
			Function.Call((Hash)0xB5352B7494A08258, ResetCastPrompt, 0xDB096B85);
			long resetCastStr = Function.Call<long>((Hash)0xFA925AC00EB830B9, 10, "LITERAL_STRING", GetConfig.Langs["Cancel"]);
			Function.Call((Hash)0x5DD02A8318420DD7, ResetCastPrompt, resetCastStr);
			Function.Call((Hash)0x8A0FB4D03A630D21, ResetCastPrompt, 0);
			Function.Call((Hash)0x71215ACCFDE075EE, ResetCastPrompt, 0);
			Function.Call((Hash)0xCC6656799977741B, ResetCastPrompt, 1);
			Function.Call((Hash)0xF7AA2696A22AD8B9, ResetCastPrompt);


			ReelInPrompt = Function.Call<int>((Hash)0x04F97DE45A519419);
			Function.Call((Hash)0xB5352B7494A08258, ReelInPrompt, 0x8FFC75D6);
			long ReelInStr = Function.Call<long>((Hash)0xFA925AC00EB830B9, 10, "LITERAL_STRING", GetConfig.Langs["ReelIn"]);
			...
			Function.Call((Hash)0xB5352B7494A08258, ReelLurePrompt, 0xD9D0E1C0);
			...
			Function.Call((Hash)0xB5352B7494A08258, ReelLurePlusPrompt, 0x6319DB71);
			...
			Function.Call((Hash)0xB5352B7494A08258, ReelLureMinusPrompt, 0x05CA7C52);
			...
			long KeepStr = Function.Call<long>((Hash)0xFA925AC00EB830B9, 10, "LITERAL_STRING", GetConfig.Langs["SaveFish"]);
			Function.Call((Hash)0x5DD02A8318420DD7, KeepPrompt, KeepStr);
			Function.Call((Hash)0x8A0FB4D03A630D21, KeepPrompt, 0);
			Function.Call((Hash)0x71215ACCFDE075EE, KeepPrompt, 0);
			Function.Call((Hash)0xCC6656799977741B, KeepPrompt, 1);
			Function.Call((Hash)0xF7AA2696A22AD8B9, KeepPrompt);

			ThrowFishBackPrompt = Function.Call<int>((Hash)0x04F97DE45A519419);
			Function.Call((Hash)0xB5352B7494A08258, ThrowFishBackPrompt, 0xE30CD707);
			long ThrowFishBackStr = Function.Call<long>((Hash)0xFA925AC00EB830B9, 10, "LITERAL_STRING", GetConfig.Langs["FreeFish"]);
			Function.Call((Hash)0x5DD02A8318420DD7, ThrowFishBackPrompt, ThrowFishBackStr);
			Function.Call((Hash)0x8A0FB4D03A630D21, ThrowFishBackPrompt, 0);
			Function.Call((Hash)0x71215ACCFDE075EE, ThrowFishBackPrompt, 0);
			Function.Call((Hash)0xCC6656799977741B, ThrowFishBackPrompt, 1);
			Function.Call((Hash)0xF7AA2696A22AD8B9, ThrowFishBackPrompt);


			HookPrompt = Function.Call<int>((Hash)0x04F97DE45A519419);
			Function.Call((Hash)0xB5352B7494A08258, HookPrompt, 0xCEFD9220);
			long HookFishStr = Function.Call<long>((Hash)0xFA925AC00EB830B9, 10, "LITERAL_STRING", GetConfig.Langs["HookFish"]);
			Function.Call((Hash)0x5DD02A8318420DD7, HookPrompt, HookFishStr);
			Function.Call((Hash)0x8A0FB4D03A630D21, HookPrompt, 0);
			Function.Call((Hash)0x71215ACCFDE075EE, HookPrompt, 0);
		...
		public int GetClosestFish(int bobberHandle)
		{
			...
			//
			//
			//   THIS BLOCK GETS THE CLOSEST ENTITIES AND TRACKS THEIR INTEREST ON THE CURRENT BAIT
			//
			//
